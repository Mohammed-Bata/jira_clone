...
namespace Application.Projects.Queries.GetProject
{
    public class GetProjectQueryHandler: IRequestHandler<GetProjectQuery, ProjectDto>
    {
        ...
        { 
            ...
            var sql = @"SELECT p.Id,p.Name,p.OwnerId,pc.Id,pc.Title,pc.[Order],i.Id,i.Title,i.[Order],i.Priority,i.DueDate,i.Type,i.AssignedToUserId,u.Name AS AssignedToUserName FROM Projects p 
